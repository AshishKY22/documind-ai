...
function StatCard({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex flex-col gap-1 border-b border-border pb-4 sm:border-b-0 sm:border-r sm:pb-0 sm:pr-6 last:border-r-0 last:pr-0">
    ...
    <div className="max-w-5xl mx-auto p-8 space-y-12">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-0">
        ...
        <div className="flex flex-col gap-1 border-b border-border pb-4 sm:border-b-0 sm:border-r sm:pb-0 sm:pr-6 last:border-r-0 last:pr-0">
          ...
          <span className="text-3xl font-serif text-foreground">{stats.currentPlan}</span>
      ...
      <div className="grid md:grid-cols-2 gap-10">
        <div>
          <h2 className="text-sm text-muted-foreground mb-3">Queries per day, last 30 days</h2>
        ...
        <div>
          <h2 className="text-sm text-muted-foreground mb-3">Documents by type</h2>
          {documentTypeBreakdown.length === 0 ? (
            <p className="text-muted-foreground/70 text-sm">No documents uploaded yet.</p>
          ) : (
            <ResponsiveContainer width="100%" height={220}>
              <PieChart>
                <Pie
      ...
      {/* Recent activity */}
      <div>
        <h2 className="text-sm text-muted-foreground mb-3">Recent activity</h2>
        {recentActivity.length === 0 ? (
          <p className="text-muted-foreground/70 text-sm">Nothing here yet. Upload a document to get started.</p>
        ) : (
